...
vim.api.nvim_set_keymap("t", "<C-v>", "<C-\\><C-n>", { noremap = true }) -- For canceling terminal mode in float terminal proccess
...
vim.api.nvim_set_keymap("i", "<C-n>", ":nohlsearch<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("t", "<C-n>", ":nohlsearch<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<C-n>", ":nohlsearch<CR>", { noremap = true, silent = true })
-- Remap Shift + R to r
...
vim.api.nvim_set_keymap("c", "<C-n>", "<CR>", { noremap = true, silent = true })

-- Command to start practicing Leetcode
vim.api.nvim_set_keymap("n", "<C-l>", "<cmd>Leet<CR>", { noremap = true, silent = true })
